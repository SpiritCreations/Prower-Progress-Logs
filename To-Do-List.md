...
## Notes
Completed items are kept here for reference rather than deleted. Dates and links to relevant files are added when items are resolved. Strike-through indicates a cancelled or shelved projects are paused for practical reasons (time, cost, or availability) and may be revisited later.
